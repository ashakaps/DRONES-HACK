...
- **ashakaps** — архитектор и инженер данных, разработка схемы базы, первичная предобработка (`src/prepoc.py`), загрузка геоданных и статистических данных, оформление документации.
- **l00fi** — инженер данных и разработчик, реализация очистки и объединения данных (`weather_parser.py`, `preprocessing.py`), построение графиков, участие в дизайне API и фронтенда.
- **angelinanana** — разработчик фронтенда, создание React‑интерфейса (авторизация, панель администратора, карта), интеграция с REST‑API и настройка сборки.  Также участвовала в доработке функций загрузки данных и визуализации.
- **petushokok**
- **zoott1c**

Проект разрабатывается в рамках хакатона ЛЦТ и открыт для предложений и улучшений.
